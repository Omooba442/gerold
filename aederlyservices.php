          ...
          <div class="col">
            <div class="breadcrumb_content d-flex flex-column align-items-center">
              ...
              <div class="breadcrumb_navigation wow fadeInUp" data-wow-delay=".5s">
                ...
                <span><a href="aederlyservices.php">Aaelderly Services</a></span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="tj-post-details__container">
              <article class="tj-single__post">
                <div class="tj-post__thumb">
                  <img src="assets/img/portfolio/aowebtec caregiver 2.png" alt="">
                ...
                About Project
                  ...
                  <div class="tj-post__content">
                    <p>A&A Elderly Care is Nigeria’s No.1 home care services provider for the elderly,vulnerable and recuperating patient with service users across South West,Nigeria.</p>

                    <video src="/assets/img/videos/aowebtech aederlyservices.mp4"  autoplay="500px" width="850px"></video>


                    
                    <h6>Key Point About this Project</h6>
                    <ul>
                      <li>We provide elderly care certification courses for people who want to migrate abroad through health care route.</li>
                      <li>A&A Elderly Care is Nigeria’s No.1 home care services provider for the elderly,vulnerable and recuperating patient with service users across South West,Nigeria.</li>

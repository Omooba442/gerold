...
<head>
  ...
  <!-- Site Title -->
  <title>Ao webtech | Cyberpastnft </title>
      ...
      <div class="row">
        <div class="col-12 d-flex flex-wrap align-items-center">
          ...
          <div class="header-info-list d-none d-md-inline-block">
            <ul class="ul-reset">
              <li><a href="mailto:Aowebtech13@gmail.com">Aowebtech13@gmail.com</a></li>
            </ul>
          </div>
        ...
        <div class="row">
          <div class="col">
            <div class="breadcrumb_content d-flex flex-column align-items-center">
              <h2 class="title wow fadeInUp" data-wow-delay=".3s">project Details</h2>
              <div class="breadcrumb_navigation wow fadeInUp" data-wow-delay=".5s">
                <span><a href="index.php">Home</a></span>
                <i class="far fa-long-arrow-right"></i>
                <span><a href="cyberpastnft.php">Cyberpast</a></span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="tj-post-details__container">
              <article class="tj-single__post">
                <div class="tj-post__thumb">
                  <img src="assets/img/portfolio/aowebtech cyberpast.png" alt="">

                  <a href="https://www.fiverr.com/" class="category">AOWEBTECH</a>
                </div>
                ...
                About Project
                  ...
                  <div class="tj-post__content">
                    <p>We are a very interested modern generation in the field of NFT business, our motto is creative and innovative ideas. We are a company made entirely of creative people and Young creative NFT artists works with a strong team, the project collection includes many interesting arts that have been revived by the cyber world, In the long run in the form of different dimensions travelers deep the future..</p>

                    <video src="/assets/img/videos/aowebtech cyberpast.mp4"  autoplay="500px" width="850px"></video>


                    
                    <h6>Key Point About Project</h6>
                    <ul>
                      <li>Our business model is based on the sale of NFTs and the development of a marketplace for NFTs. We will offer a wide range of Home, including the creation of NFTs, the sale of NFTs, and the development of a marketplace for NFTs..</li>
                      <li>The goal of creating a community around Project NFT Art is to create meaningful relationships fueled by feedback, encouragement, and engagement. A dedicated community interacts with the refined content of the project, follows it on its long-term perspective journey, sees the value of the project's work, and looks forward to the project's future NFT ups and downs to success.</li>
                ...
                <div class="tj-navigation_post previous">
                  ...
                  <div class="tj-navigation-post_inner prev_post">
                    <div class="navigation-post_img">
                      <a href="#">
                        <img src="assets/img/IMG_20240403_174254_185@-392513335.jpg" alt=""> </a>
                    </div>
                    <div class="tj-content">
                      ...
                      <div class="post_pagination_title">
                        <h5 class="title">
                          <a href="leacent.php">Leacent Agriculture</a>
                        </h5>
                      </div>
                    </div>
                  </div>
                ...
                <div class="tj-navigation_post next">
                  ...
                  <div class="tj-navigation-post_inner next_post">
                    ...
                    <div class="tj-content">
                      ...
                      <div class="post_pagination_title">
                        <h5 class="title">
                          <a href="sugarchat.php">Sugarchat</a>
                        </h5>
                      </div>
                    </div>
                    <div class="navigation-post_img">
                      <a href="#">
                        <img src="assets/img/IMG-20240507-WA0006.jpg" alt=""> </a>
                    </div>
                  </div>
                </div>
              </div>

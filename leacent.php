...
<head>
  ...
  <!-- Site Title -->
  <title>A.O webtech | Brillfund</title>
        ...
        <div class="row">
          <div class="col">
            <div class="breadcrumb_content d-flex flex-column align-items-center">
              <h2 class="title wow fadeInUp" data-wow-delay=".3s">Brillfund</h2>
              <div class="breadcrumb_navigation wow fadeInUp" data-wow-delay=".5s">
                <span><a href="index.php">Home</a></span>
                <i class="far fa-long-arrow-right"></i>
                <span><a href="/brillfund.php">Brillfund</a></span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="tj-post-details__container">
              <article class="tj-single__post">
                <div class="tj-post__thumb">
                  <img src="assets/img/IMG-20240507-WA0006.jpg" height="500px" width="800px" alt="">

                  <a href="https://www.fiverr.com/" class="category">AOWEBECH</a>
                </div>
                ...
                <div class="tj-post__content">
                  ...
                  <div class="tj-post__content">
                    <p>BRILLFUND NETWORK is an unique 3in1 platform designed to engage humans into performing some mini social task and ensuring they get paid through the company's revenue and sponsorship by BRILLFUND ADMINISTRATORS..</p>

                

                   
                    <video src="assets/img/videos/aowebtech-brilfund.mp4" height="500px" width="850px"  <i class="<i class="fa fa-play-circle" aria-hidden="true"></i>"></i>></video>
                    <h6>Key Points About Project</h6>
                    <ul>
                      <li>It is ensured that every user makes a continuous withdrawable income from their task and our outstanding features and will get their wages delivered to their bank account irrespective of their location while also ensuring that our promoters through networking will also get adequate value back for their time spent.</li>
              ...
              <div class="single-post_tag_share ">
                ...
                <div class="share_link">
                  ...
                  <a href="https://twitter.com/Adeyem1Omooba" class="twitter" title="Share this on Twitter" target="_blank"><i class="fa-brands fa-x-twitter"></i></a>
                ...
                <div class="tj-navigation_post previous">
                  ...
                  <div class="tj-navigation-post_inner prev_post">
                    <div class="navigation-post_img">
                      <a href="#">
                        <img src="assets/img/IMG_20231127_115948_338@-375390277.jpg" alt=""> </a>
                    </div>
                ...
                <div class="tj-navigation_post next">
                  ...
                  <div class="tj-navigation-post_inner next_post">
                    ...
                    <div class="tj-content">
                      ...
                      <div class="post_pagination_title">
                        <h5 class="title">
                          <a href="funnel.php">Funnel Upscale</a>
                        </h5>
                      </div>
                    </div>
                    <div class="navigation-post_img">
                      <a href="#">
                        <img src="assets/img/IMG-20240507-WA0004.jpg" alt=""> </a>
                    </div>
                  </div>
                </div>
              </div>
